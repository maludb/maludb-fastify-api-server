...
import { register as skillsIdBundle } from '../routes/v1/skills_id_bundle.js';
import { register as skillsIdDuplicate } from '../routes/v1/skills_id_duplicate.js';
import { register as skillsIngest } from '../routes/v1/skills_ingest.js';
...
export async function registerRoutes(app: FastifyInstance): Promise<void> {
  ...
  await skills(app);
  await skillsId(app);
  await skillsIdBundle(app);
  await skillsIdDuplicate(app);
  await skillsIngest(app);
